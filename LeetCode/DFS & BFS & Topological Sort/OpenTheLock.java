...
public class OpenTheLock {
    ...
    //TC: O(1e4) or O(1) since regardless of target or deadends, there will always be 10^4 combinations
    public int openLock(String[] deadends, String target) {
        ...
        /*
            ...
            essentially we search through all 10^4 possible combinations until we either hit the target or exhaust all
            options
        */
        while (!queue.isEmpty()) {
            int size = queue.size();
            ...
            while (size-- > 0) {
                ...
                //add to the queue the next possible combinations made from the current lock
