...
class intervalListIntersectionTest {
    ...
    void EqualSizedLists() {
        ...
        assertArrayEquals(new int[][]{{1, 2}, {5, 5}, {8, 10}, {15, 23}, {24, 24}, {25, 25}}, intersections);
    ...
    void OneEmptyList() {
        ...
        assertArrayEquals(new int[][]{}, intersections);
        System.out.println("Intersections: " + Arrays.deepToString(intersections));
    }
    ...
    void UnEvenSizedLists() {
        ...
        assertArrayEquals(new int[][]{{1, 3}, {5, 6}}, intersections);
        System.out.println("Intersections: " + Arrays.deepToString(intersections));
    }
}