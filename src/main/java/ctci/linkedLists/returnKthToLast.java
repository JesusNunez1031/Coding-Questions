...
//        head.next.next = new ctci.linkedLists.ListNode(3);
//        head.next.next.next = new ctci.linkedLists.ListNode(4);
//        head.next.next.next.next = new ctci.linkedLists.ListNode(5);
//        head.next.next.next.next.next = new ctci.linkedLists.ListNode(6);

        System.out.println(returnKthToLast(head, 1).val);
