...
public class baseballGame {
    ...
    the ith operation you must apply to the record and is one of the following:
         ...
         5.   Return the sum of all the scores on the record.
    ...
    public static int calPoints(String[] ops) {
        ...
        for (String s : ops) {
//            //add the record
//            if (s.matches("-?\\d+")) {  //check if the string is an integer with/without a negative sign
...
//            }
            ...
            switch (s) {
                ...
                case "C":
                    sum -= scores.pop();
                    break;
                //Add a new record double the previous score
                case "D":
    ...
    public static void main(String[] args) {
        String[] ac = {"5", "-2", "4", "C", "D", "9", "+", "+"};

        System.out.println(calPoints(ac));
    }
}
