...
public class StoneGameVII {
    ...
    Constraints:
        ...
        1 <= stones[i] <= 1000
     */
    //TC: O(n ^ 2) since we check for all possible leetCode.backtracking.combinations of stone scores
    ...
    //TC: O(n ^ 2) better than previous method since we don't have to recurse to find all possible leetCode.backtracking.combinations
