...
public class combinationSumIV {
    /*
    Given an integer array with all positive numbers and no duplicates, find the number of possible leetCode.backtracking.combinations that add up to a positive integer target.
    ...
    (2, 2)
    (3, 1)
    Note that different sequences are counted as different leetCode.backtracking.combinations.
    ...
    /*
        ...
        Follow up: The use of negative numbers opens up the chance of an infinite loop since there can be infinite number
                   ...
                   using 5, and an infinite number of leetCode.backtracking.combinations of (5,-5), so (5, (-5,5)). To allow negatives and an
