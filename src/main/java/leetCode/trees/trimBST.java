...
public class trimBST {
    ...
    public TreeNode trimBST(TreeNode root, int low, int high) {
        ...
        /*
            when the value of the current node is less than low, trim the root.left subtree by moving to the right subtree
            and if the current nodes is greater than the high, trim the right subtree and go to the left subtree
         */
        if (root.val < low) {
        ...
        //set the left and right subtrees to the nodes trees in the ranges of [low, high]
