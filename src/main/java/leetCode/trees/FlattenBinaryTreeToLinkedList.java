...
public class FlattenBinaryTreeToLinkedList {
    ...
    Given the root of a binary tree, flatten the tree into a "linked list":
        - The "linked list" should use the same leetCode.trees.TreeNode class where the right child pointer points to the next node in
    ...
    Constraints:
        ...
        -100 <= leetCode.trees.Node.val <= 100
