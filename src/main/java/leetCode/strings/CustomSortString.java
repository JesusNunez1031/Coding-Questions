...
public class CustomSortString {
    ...
    public String customSortString(String order, String str) {
        int[] freq = new int[26]; // all characters are lowercase

        //get the frequency of each character in str
        ...
        //append characters from str in the order that they appear in "order"
        ...
        //append the remaining characters in str
        for (int i = 0; i < 26; i++) {
            int count = freq[i];
            while (count > 0) {
                //to get the char value of the character at index c, we add 'a'
                sb.append((char) (i + 'a'));
                count--;
            }
        }
