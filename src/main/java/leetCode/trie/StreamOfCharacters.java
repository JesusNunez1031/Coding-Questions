...
public class StreamOfCharacters {
    ...
    class StreamChecker {
        ...
        public boolean query(char letter) {
            ...
            for (int i = sb.length() - 1; i >= 0 && iter != null; i--) {
                char c = sb.charAt(i);
                iter = iter.child[c - 'a'];

                // check if the current node of letter is the end of a prefix
        ...
        private void buildTrie(String[] words) {
            for (String word : words) {
                TrieNode iter = root;
                /*
                    add new words starting from the end of the word so when we look for a prefix, we can start from the
                    end of the generated string created from queries.
                 */
                ...
                iter.isWord = true; // mark end of word
            }
        }
    }
}
