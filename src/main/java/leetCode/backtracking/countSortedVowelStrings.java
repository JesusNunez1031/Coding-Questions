...
public class countSortedVowelStrings {
    ...
    /*
        TC:O(5^n) since we check through all possible leetCode.backtracking.combinations of vowels and rejecting those leetCode.backtracking.combinations of unsorted
    ...
    /*
        ...
        order than last_character, and returns all valid leetCode.backtracking.combinations.
     */
    private int calculateVowels(int length, char last_character) {
        ...
        //variable to hold all the valid sorted leetCode.backtracking.combinations of sorted vowel strings
