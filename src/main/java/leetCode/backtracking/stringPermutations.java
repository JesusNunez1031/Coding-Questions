...
public class stringPermutations {
    /*
    Given a string of all unique letters, return a list containing all the leetCode.backtracking.permutations of the string
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("There are %d leetCode.backtracking.permutations for %s \nPermutations: %s", permutations.size(), str, permutations.toString());
    }
}
