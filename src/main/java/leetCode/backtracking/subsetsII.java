...
public class subsetsII {
    /*
    Given a collection of integers that might contain duplicates, nums, return all possible leetCode.backtracking.subsets (the power set).

    Note: The solution set must not contain duplicate leetCode.backtracking.subsets.
     ...
     */
    //TC: O(n log n + (n * 2^n)) where n is the length of nums, 2^n possible leetCode.backtracking.combinations
