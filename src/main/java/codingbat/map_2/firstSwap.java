...
public class firstSwap {
    ...
    codingbat.map_2.firstSwap(["ab", "ac"]) → ["ac", "ab"]
    codingbat.map_2.firstSwap(["ax", "bx", "cx", "cy", "by", "ay", "aaa", "azz"]) → ["ay", "by", "cy", "cx", "bx", "ax", "aaa", "azz"]
    codingbat.map_2.firstSwap(["ax", "bx", "ay", "by", "ai", "aj", "bx", "by"]) → ["ay", "by", "ax", "bx", "ai", "aj", "bx", "by"]
     */
