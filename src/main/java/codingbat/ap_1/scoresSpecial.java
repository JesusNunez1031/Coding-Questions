...
public class scoresSpecial {
    ...
    your codingbat.ap_1.scoresSpecial() method in the JavaBat text area.

    codingbat.ap_1.scoresSpecial([12, 10, 4], [2, 20, 30]) → 40
    codingbat.ap_1.scoresSpecial([20, 10, 4], [2, 20, 10]) → 40
    codingbat.ap_1.scoresSpecial([12, 11, 4], [2, 20, 31]) → 20
     */
