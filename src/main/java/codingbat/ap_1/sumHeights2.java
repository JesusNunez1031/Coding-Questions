...
public class sumHeights2 {
    /*
    (A variation on the codingbat.ap_1.sumHeights problem.) We have an array of heights, representing the altitude along a walking trail.
    ...
    codingbat.ap_1.sumHeights2([5, 3, 6, 7, 2], 2, 4) → 7
    codingbat.ap_1.sumHeights2([5, 3, 6, 7, 2], 0, 1) → 2
    codingbat.ap_1.sumHeights2([5, 3, 6, 7, 2], 0, 4) → 15
     */
