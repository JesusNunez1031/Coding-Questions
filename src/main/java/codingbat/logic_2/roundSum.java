...
public class roundSum {
    ...
    Write the helper entirely below and at the same indent level as codingbat.logic_2.roundSum().

    codingbat.logic_2.roundSum(16, 17, 18) → 60
    codingbat.logic_2.roundSum(12, 13, 14) → 30
    codingbat.logic_2.roundSum(6, 4, 4) → 10
     */
