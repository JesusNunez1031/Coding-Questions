...
public class groupNoAdj {
    ...
    codingbat.recursion_2.groupNoAdj(0, [2, 5, 10, 4], 12) → true
    codingbat.recursion_2.groupNoAdj(0, [2, 5, 10, 4], 14) → false
    codingbat.recursion_2.groupNoAdj(0, [2, 5, 10, 4], 7) → false
     */
