...
//        assertEquals(1, codewars.others.stringNumberToInteger.parseInt("one"));
//        assertEquals(20, codewars.others.stringNumberToInteger.parseInt("twenty"));
//        assertEquals(246, codewars.others.stringNumberToInteger.parseInt("two hundred forty-six"));
//    }
