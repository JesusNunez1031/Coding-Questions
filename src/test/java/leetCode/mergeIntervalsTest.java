...
class mergeIntervalsTest {
    ...
    void MergeTwoIntervals() {
        ...
        Assertions.assertArrayEquals(new int[][]{{10, 100}}, merged);
    ...
    void MergeThreeIntervals() {
        ...
        Assertions.assertArrayEquals(new int[][]{{1, 3},{4, 10}}, merged);
        System.out.println("Merged intervals: " + Arrays.deepToString(merged));
    ...
    void MergeFourIntervals() {
        ...
        Assertions.assertArrayEquals(new int[][]{{1, 18}}, merged);
        System.out.println("Merged intervals: " + Arrays.deepToString(merged));
